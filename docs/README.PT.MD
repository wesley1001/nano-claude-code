...
> Observação: blocos de código, comandos, nomes de modelos, nomes de pacotes e caminhos de arquivos foram mantidos quase sem alterações de propósito para preservar o uso direto.
