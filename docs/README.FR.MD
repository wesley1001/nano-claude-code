...
> Remarque : les blocs de code, commandes, noms de modèles, noms de paquets et chemins de fichiers sont volontairement conservés presque tels quels afin de rester directement utilisables.
